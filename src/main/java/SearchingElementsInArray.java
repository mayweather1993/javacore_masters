...
public class SearchingElementsInArray {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 21; i < 100; i++) {
            ...
            int[] result = SearchingElementsInArray.twoMaxElements(array);
            int[] resultSort = SearchingElementsInArray.topKSort(arrayCopy, 2);
        ...
        for (int i = 21; i < 100; i++) {
            array = ArrayAlgorithms.randomArray(21);
            arrayCopy = ArrayAlgorithms.copyArray(array);
            int[] resultInsertion = SearchingElementsInArray.topKInsertion(array, 20);
            int[] resultSort = SearchingElementsInArray.topKSort(arrayCopy, 20);
        ...
        for (int i = 21; i < 100; i++) {
            ...
            arrayCopy = ArrayAlgorithms.copyArray(array);
            int[] resultInsertion = SearchingElementsInArray.topKSelection(array, 20);
            int[] resultSort = SearchingElementsInArray.topKSort(arrayCopy, 20);
            assertEquals(resultInsertion.length, resultSort.length);
            assertEquals(resultInsertion[0], resultSort[0]);
            assertTrue(ArrayAlgorithms.equals(resultInsertion, resultSort));
        ...
        for (int i = 21; i < 100; i++) {
            array = ArrayAlgorithms.randomArray(i);
            arrayCopy = ArrayAlgorithms.copyArray(array);
            int[] resultInsertion = SearchingElementsInArray.topKRandomized(array, 20);
            int[] resultSort = SearchingElementsInArray.topKSort(arrayCopy, 20);
            assertEquals(resultInsertion.length, resultSort.length);
